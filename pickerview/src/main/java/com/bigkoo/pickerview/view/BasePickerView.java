...
import com.bigkoo.pickerview.utils.AnimationUtil;
...
public class BasePickerView {
    ...
    protected void initViews() {
        ...
        if (isDialog()) {
            ...
            dialogView = (ViewGroup) layoutInflater.inflate(R.layout.layout_basepickerview, null, false);
            //设置界面的背景为透明
//           dialogView.setBackgroundColor(0x88000000);
            //这个是真正要加载选择器的父布局
            contentContainer = (ViewGroup) dialogView.findViewById(R.id.content_container);
            contentContainer.setLayoutParams(params);
            createPop();
    ...
    private void createPop() {
        if (dialogView != null) {
            ...
            popupWindow.setOutsideTouchable(mPickerOptions.cancelable);//不能点外面取消,也不能点back取消
            popupWindow.setContentView(dialogView);
            popupWindow.setAnimationStyle(R.style.SelectPopupWindow);
    ...
    private void showPop() {
        if (popupWindow != null) {
            ...
            if (Build.VERSION.SDK_INT < 24) {
                AnimationUtil.createAnimation(true, dialogView, contentContainer, null);
                ...
                int height = screenHeight - clickView.getHeight() - locations[1];
