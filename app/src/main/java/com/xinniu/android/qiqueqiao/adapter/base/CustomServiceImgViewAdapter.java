...
public class CustomServiceImgViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CustomServiceImgViewAdapter(Context context, ArrayList<String> list, int max) {
        ...
        mAllImageWidth = screenWidth - DensityUtil.dp2px(72);
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof ViewHodler) {
            ...
            if (mList.size() < max) {
                ((AddViewHolder) holder).itemAddIv.setImageResource(R.mipmap.photo_addimg);
