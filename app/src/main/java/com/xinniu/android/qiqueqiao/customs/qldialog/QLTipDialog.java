...
public class QLTipDialog extends QLDialog {
    ...
    public QLTipDialog(Context context, int theme) {
        super(context, theme);
    }
    ...
    public static class Builder extends QLDialog.AQLDialogBuilder<QLTipDialog.Builder> {
        ...
        protected AppCompatDialog buildWithTheme(Context mContext, int mTheme) {
            return new QLTipDialog(mContext, mTheme);
        }
        ...
        protected void buildDialog(QLDialog dialog) {
            QLTipDialog qlDialog = (QLTipDialog) dialog;
            setView(qlDialog, R.layout.dialog_tip);
