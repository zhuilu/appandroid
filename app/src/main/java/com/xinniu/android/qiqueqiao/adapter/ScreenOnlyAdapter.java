...
public class ScreenOnlyAdapter extends BaseQuickAdapter<SelectCategory,BaseViewHolder> {
    ...
    public ScreenOnlyAdapter(Context context,int layoutResId, @Nullable List<SelectCategory> data) {
    ...
    public ScreenOnlyAdapter(int layoutResId) {
        super(layoutResId);
    }
