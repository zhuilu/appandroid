...
@ProviderTag(messageContent = HeadMessage.class, showPortrait = true, centerInHorizontal = true)
public class HeadMessageProvider extends IContainerItemProvider.MessageProvider<HeadMessage> {
