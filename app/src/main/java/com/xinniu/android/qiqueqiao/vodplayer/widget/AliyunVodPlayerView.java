package com.xinniu.android.qiqueqiao.vodplayer.widget;
...
import com.xinniu.android.qiqueqiao.vodplayer.utils.NetWatchdog;
import com.xinniu.android.qiqueqiao.vodplayer.utils.OrientationWatchDog;
import com.xinniu.android.qiqueqiao.vodplayer.utils.ScreenUtils;
import com.xinniu.android.qiqueqiao.vodplayer.view.control.ControlView;
import com.xinniu.android.qiqueqiao.vodplayer.view.gesture.GestureDialogManager;
import com.xinniu.android.qiqueqiao.vodplayer.view.gesture.GestureView;
import com.xinniu.android.qiqueqiao.vodplayer.view.guide.GuideView;
import com.xinniu.android.qiqueqiao.vodplayer.view.interfaces.ViewAction;
import com.xinniu.android.qiqueqiao.vodplayer.view.more.SpeedValue;
import com.xinniu.android.qiqueqiao.vodplayer.view.quality.QualityView;
...
public class AliyunVodPlayerView extends RelativeLayout {
    ...
    public void changeSpeed(SpeedValue speedValue) {
        if (speedValue == SpeedValue.One) {
            ...
            currentSpeed = 2.0f;
        } else if (speedValue == SpeedValue.OneHalff) {
            currentSpeed = 1.75f;
        } else if (speedValue == SpeedValue.Normalf) {
            currentSpeed = 0.75f;
        }
    ...
    private void changedToLandScape(boolean fromPort) {
        ...
        if (mCurrentScreenMode == AliyunScreenMode.Full) {
            ...
            //竖屏显示全部控制栏，横屏则显示全部控制栏，否则不显示控制栏
            if (mControlView != null) {

                if (mControlView.getmControlBar().getVisibility() == VISIBLE) {
                    mControlView.show();
                } else {
                    mControlView.hide(ControlView.HideType.Normal);
                ...
                if (fromLand) {
                    ...
                    if (mControlView != null) {
                        ...
                        if (mControlView.getVisibility() == VISIBLE) {
                            ...
                            mControlView.show();
                            mControlView.getmControlBar().setVisibility(GONE);
                            mControlView.getmTitleBar().setBackgroundDrawable(null);
                        }
    ...
    private void initControlView() {
        ...
        mControlView.setOnQualityBtnClickListener(new ControlView.OnQualityBtnClickListener() {
            ...
            public void onQualityBtnClick(View v, List<String> qualities, String currentQuality) {
                ...
                mQualityView.show(mCurrentScreenMode);
            }
    ...
    private void initSpeedView() {
        ...
        mSpeedView.setOnSpeedClickListener(new SpeedView.OnSpeedClickListener() {
            ...
            public void onSpeedClick(SpeedView.SpeedValue value) {
                if (value == SpeedView.SpeedValue.NO) {
                    ...
                    if (value == SpeedView.SpeedValue.Normal) {
                        ...
                        speed = 2.0f;
                    } else if (value == SpeedView.SpeedValue.Normalf) {
                        speed = 0.75f;
                    } else if (value == SpeedView.SpeedValue.OneHalff) {
                        speed = 1.75f;
                    }
                    ...
                    mControlView.setmCurrentSeep(value);
                }
                mControlView.show();
            }
            ...
            public void onSingleTap() {
                ...
                if (mControlView != null) {
                    if (mCurrentScreenMode == AliyunScreenMode.Full) {
                        ...
                        if (mControlView.getmControlBar().getVisibility() != VISIBLE) {
                            mControlView.show();
                            mControlView.getmControlBar().setVisibility(VISIBLE);
                        } else {
                            mControlView.getmControlBar().setVisibility(GONE);
                            mControlView.getmTitleBar().setBackgroundDrawable(null);//设置背景阴影
                        }
    ...
    private void initAliVcPlayer() {
        ...
        mAliyunVodPlayer.setOnPreparedListener(new IAliyunVodPlayer.OnPreparedListener() {
            ...
            public void onPrepared() {
                ...
                mControlView.show();
                mGestureView.show();//小屏不显示手势控制
                mGestureView.setScreenLockStatus(true);//设置这个值运行单击操作
                if (mTipsView != null) {
        ...
        mAliyunVodPlayer.setOnCompletionListener(new IAliyunVodPlayer.OnCompletionListener() {
            ...
            public void onCompletion() {
                ...
                if (mTipsView != null) {
                    ...
                    mTipsView.showReplayTipView(mAliyunMediaInfo.getPostUrl());
                }
    ...
    public void start() {
        ...
        mGestureView.show();
        if (mCurrentScreenMode == AliyunScreenMode.Small) {
            mGestureView.setScreenLockStatus(true);
        } else {
            mGestureView.setScreenLockStatus(false);
        }
