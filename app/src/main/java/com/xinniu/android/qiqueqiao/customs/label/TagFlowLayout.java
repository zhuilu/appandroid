...
public class TagFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener {
    ...
    private static boolean noSelect = false;

    public static void setNoSelect(boolean noSelect) {
        TagFlowLayout.noSelect = noSelect;
    }
        ...
        if (mAutoSelectEffect) {
            if (!child.isChecked()) {
                ...
                if (mSelectedMax == 1 && mSelectedView.size() == 1) {
                    ...
                    ToastUtils.showCentetToast(getContext(),"只能选择6个标签");
                }
            } else {
