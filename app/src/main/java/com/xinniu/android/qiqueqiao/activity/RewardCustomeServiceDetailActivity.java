...
public class RewardCustomeServiceDetailActivity extends BaseActivity {
    ...
    private GuaranteeServiceInfoBean mBean;
    public static void start(Context context, String order_sn, int id) {
        Intent starter = new Intent(context, RewardCustomeServiceDetailActivity.class);
    ...
    private void getData(int id) {
        showBookingToast(1);
        RequestManager.getInstance().serviceRewardInfo(id, new GetGuaranteeServiceinfoCallback() {
            @Override
            public void onSuccess(GuaranteeServiceInfoBean item) {
                ...
                if (StringUtils.isEmpty(item.getThumb_img())) {
                    ...
                    final LinearLayoutManager manager = new LinearLayoutManager(RewardCustomeServiceDetailActivity.this, LinearLayoutManager.HORIZONTAL, false);
                    refundPhotoRecycler03.setLayoutManager(manager);
                    RefundDetailPhotoAdapter  photoAdapter2 = new RefundDetailPhotoAdapter(R.layout.item_recycler_refund, thumbList, RewardCustomeServiceDetailActivity.this, photoList);
            ...
            public void onFailed(int code, String msg) {
                dismissBookingToast();
                ToastUtils.showCentetImgToast(RewardCustomeServiceDetailActivity.this, msg);
            }
        });
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
         ...
         //    PersonCentetActivity.start(RewardCustomeServiceDetailActivity.this,mBean.getUser_id()+"");
                break;
        }
    }
