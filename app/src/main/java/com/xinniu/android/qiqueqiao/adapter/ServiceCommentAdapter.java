...
public class ServiceCommentAdapter extends BaseExpandableListAdapter {
    ...
    public ServiceCommentAdapter(Context context, List<InquireBean.ListBean> commentList) {
...
//            Log.e(TAG, "addTheReplyData: >>>>该刷新回复列表了:"+replyDetailBean.toString() );
    ...
    public void setSetOnClick(ServiceCommentAdapter.setOnClick setOnClick) {
