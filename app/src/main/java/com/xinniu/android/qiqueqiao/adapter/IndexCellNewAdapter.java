...
public class IndexCellNewAdapter extends BaseAdapter {
    private Context mContext;
    private LayoutInflater inflater;
    private List<MainBean.NavBean> data;

    public IndexCellNewAdapter(Context context, List<MainBean.NavBean> data) {
