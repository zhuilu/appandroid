...
public class ScreenOnlyWindow extends PopupWindow implements PopupWindow.OnDismissListener {
    ...
    private void initWindow(){
        ...
        TextView textView = (TextView) industryView.findViewById(R.id.tvOfferWindow);
        textView.setText(title);
        GridLayoutManager manager = new GridLayoutManager(activity,4);
        recyclerView.setLayoutManager(manager);
        final ScreenOnlyAdapter adapter = new ScreenOnlyAdapter(activity,R.layout.item_source_screen_cell,datas);
