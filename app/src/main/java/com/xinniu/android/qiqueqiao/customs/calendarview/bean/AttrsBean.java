package com.xinniu.android.qiqueqiao.customs.calendarview.bean;
...
public class AttrsBean {
    ...
    private int[] startDate;//日历的开始年、月，日
    ...
    private int colorSolar = Color.parseColor("#FF5C6AA4");//阳历的日期颜色
    private int colorLunar = Color.parseColor("#ffcccccc");//阴历的日期颜色
    ...
    private int dayBg = R.drawable.bg_calendarview_cricle;//选中的背景
    private Map<String, String> specifyMap;//指定日期对应的文字map
    private int chooseType = 0;//表示日历是单选还是多选
    private Map<String, String> man;//指定日期对应的文字map
    ...
    public Map<String, String> getMan() {
        return man;
    }

    public void setMan(Map<String, String> man) {
        this.man = man;
    }
