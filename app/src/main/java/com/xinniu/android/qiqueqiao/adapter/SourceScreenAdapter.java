...
public class SourceScreenAdapter extends BaseQuickAdapter<SourceScreenBean.CooperationListBean,BaseViewHolder>{
    private List<SourceScreenBean.CooperationListBean> data = new ArrayList<>();
    private Context mContext;
    private int mAllImageWidth;


    public SourceScreenAdapter(Context mContext, int layoutResId, @Nullable List<SourceScreenBean.CooperationListBean> data) {
    ...
    public SourceScreenAdapter(@Nullable List<SourceScreenBean.CooperationListBean> data) {
        super(data);
    }

    public SourceScreenAdapter(int layoutResId) {
        super(layoutResId);
    }

    @Override
    protected void convert(BaseViewHolder helper, final SourceScreenBean.CooperationListBean item) {
