...
import com.xinniu.android.qiqueqiao.activity.CompanyCellActivity;
import com.xinniu.android.qiqueqiao.activity.CompanySearchActivity;
...
public class CompanyFragment extends LazyBaseFragment implements IDynamicSore {
    ...
    @OnClick({R.id.bfragment_city, R.id.bsearch_company})
