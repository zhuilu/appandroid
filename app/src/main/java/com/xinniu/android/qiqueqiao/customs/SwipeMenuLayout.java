...
public class SwipeMenuLayout extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < count; ++i) {
            ...
            } else if (attr == R.styleable.SwipeMenuLayout_iosTwo) {
    ...
    public addSlideClickListener mListener;

    public interface addSlideClickListener {
    ...
    public void setAddSlideListener(addSlideClickListener listener) {
