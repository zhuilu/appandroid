...
public class TakePhotoActivity extends BaseGalleryActivity implements View.OnClickListener{
    ...
    public void onSelectedSuccess() {
        new QLTipDialog.Builder(TakePhotoActivity.this)
                .setCancelable(true)
