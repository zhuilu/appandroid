...
public class CountDownTextViewTwo extends android.support.v7.widget.AppCompatTextView {
    /**
     * 提示文字
     */
    ...
    public CountDownTextViewTwo(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public CountDownTextViewTwo(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//                    Log.e("l", mLastMillis + "");
    ...
    public void setUsable(boolean usable) {
        ...
        if (usable) {
            ...
            setText(mLastMillis / 1000 + mCountUnit);
        }
